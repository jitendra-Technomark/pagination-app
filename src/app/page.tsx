...
const Page: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Pagination totalPages={totalPages} onChangePage={handleChangePage} />

      {/* pagination with arrow and space */}
      <Pagination space totalPages={totalPages} onChangePage={handleChangePage} />

      {/* pagination with button */}
      <Pagination variant="buttons" totalPages={totalPages} onChangePage={handleChangePage} />
